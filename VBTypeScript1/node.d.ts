...
/**
 * setImmediate will call the function inside after I/O bound functions, but before setTimeout.
 * process.on will work with setImmediate. But process.nextTick will block process.on,
 * because process.nextTick actually push the callback to the top of event loop before checking all other things.
 * @param callback
 * @param args
 */
